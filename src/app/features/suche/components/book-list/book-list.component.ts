  ...
  template: `
    <div class="list-container">
      ...
      @if (
        ...
        !stateService.error() &&
        stateService.hasSearched() &&
        stateService.books().length === 0
      ) {
          ...
          @for (buch of stateService.books(); track buch.id) {
            <mat-card class="book-card slide-up">
              ...
              <mat-card-content class="book-content">
                <div class="book-meta">
                  ...
                  <div class="rating-price-row">
                    <div class="rating"><span class="stars">★</span> {{ buch.rating }}</div>
                    <div class="price">
              ...
              <mat-card-actions align="end">
                <button mat-button color="primary" (click)="showDetails(buch)">DETAILS</button>
              </mat-card-actions>
            </mat-card>
          }
        </div>
...
export class BookListComponent {
  constructor(
    readonly stateService: SearchStateService,
